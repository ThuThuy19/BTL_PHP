                ...
                <div class="container">
                    <div class="header__top">
                        ...
                        <div class="header__icon">
                            ...
                            <a href="kiemtradonhang.php"><i class="fa-solid fa-truck-fast"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="header-inner">
                        <a href="" class="header__logo">
                            ...
                            <span class="shop-name">DÊ NÚI TÚ QUYÊN</h2>
                        </a>
                        ...
                        <div class="header__nav">
                            <ul class="nav-bar">
                                ...
                                <li><a class="nav-item" href="#combo">Combo</a></li>
                                <li><a class="nav-item" href="#event-list">Khuyến mãi</a></li>
                                ...
                                <div class="col-md-4">
                                    <div class="product-item mb-4 img d-flex align-items-end" data-aos="fade-up" style="background-image:url(image/<?=$row['hinhAnh']?>)">
                                        ...
                                        <div class="product-desc w-100 px-4">
                                            ...
                                            <a href="giohang.php?id=<?=$row['ID']?>&tenMon=<?=$row['tenMon']?>&gia=<?=$row['giaMon']?>" class="product-icon">
